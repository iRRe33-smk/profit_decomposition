...
for i =1:NrF
    ...
    delta_barPrice_riskfactors(:,:,end) = delta_barPrice_riskfactors(:,:,end) + delta_barPrice_riskfactors(:,:,i);
end
%delta_barPrice_riskfactors(:,:,end) = delta_barPrice; %this seemed to be
%wrong, changed to last line in loop. 
